...
<p align="center" class="title">Добавление владельца</p>

<form action="adding_vlad.php" method="post" name="form">
<p class="txt">
ФИО: <input name="fio" type="text" size="40" maxlength="255"><br><br>
Дата рожд.: <input name="date" type="text" size="20" maxlength="255"><br><br>
