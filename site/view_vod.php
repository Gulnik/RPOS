...
<p align="center" class="title">Водители</p>
<p class="txt">
<?php
...
$result = mysql_query ("SELECT fio, date, shtraf, dtp, money FROM voditel");
$myrow = mysql_fetch_array ($result);

do {
echo "<b>ФИО</b>: ".$myrow['fio']."<br>";
echo "<b>Дата рождения</b>: ".$myrow['date']."<br>";
if ($myrow['money']!='0') echo "Сумма неуплаченных штрафов ".$myrow['money']." рублей<br>Имелись штрафы за: ".$myrow['shtraf']."<br>";
if ($myrow['dtp']!='0') echo "Побывал в ДТП ".$myrow['dtp']." раз<br>";
echo "<br>";
