...
<p align="center" class="title">Редактирование автомобиля</p>

<form action="editing_car_go.php" method="post">
<p class="txt">


Номер: <input name="num" type="text" size="20" maxlength="255" value="<?php echo $myrow['num'] ?>" ><br><br>
Марка: <input name="mark" type="text" size="40" maxlength="255" value="<?php echo $myrow['mark'] ?>"><br><br>
Угон: <input name="ugon" type="text" size="20" maxlength="255" value="<?php echo $myrow['ugon'] ?>"><br><br>
