...
<p align="center" class="title">Водители, побывавшие в ДТП</p>
<p class="txt">
<?php
...
$result = mysql_query ("SELECT fio, date, dtp FROM voditel WHERE dtp>0");
$myrow = mysql_fetch_array ($result);

do {
echo "<b>ФИО</b>: ".$myrow['fio']."<br>";
echo "<b>Дата рождения</b>: ".$myrow['date']."<br>";
echo "Побывал в ДТП <b>".$myrow['dtp']."</b> раз<br>";
