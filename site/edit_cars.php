...
<form action="editing_car.php" method="post" name="form">
<p class="txt">
...
$result = mysql_query ("SELECT id, num, mark FROM cars",$db);
$myrow = mysql_fetch_array ($result);

do
{
	printf ("<input name = 'id' type = 'radio' value ='%s' <label> %s, %s</label><br>", $myrow['id'], $myrow['num'], $myrow['mark']);
